# Baseline: 2026-09-25_recovered-vault-agent-stale-token

## Generic summary (from manifest.yaml)

- Purpose: Recovered from vault-agent's token silently going stale (gotcha #9) after ~16h uptime, coincidentally noticed right after v3 UI testing but unrelated to it — full recovery + both test suites confirmed green
- Captured at: 2026-09-25T06:17:06Z (UTC)
- Source commit: `9b5f79b7de8d5885788b100626fb5ee7efabddb5` on branch `main`
- Working tree dirty: true
- Previous baseline: 2026-09-24_v3-root-credential-path-built
