# Baseline: 2026-09-22_post-v2-02-02-orchestrator

## Generic summary (from manifest.yaml)

- Purpose: After 02_02: v2 DAG orchestrator, routes, watchdog, fencing — live-verified full run cycle including crash-recovery-retry; found/fixed a missing Postgres grant and two orchestrator bugs (stuck retry, stale-fencing gap)
- Captured at: 2026-09-22T13:49:57Z (UTC)
- Source commit: `06fe287726842667f765f475df63aa34fe86908c` on branch `main`
- Working tree dirty: true
- Previous baseline: 2026-09-22_pre-v2-02-02-orchestrator
