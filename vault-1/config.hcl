...
storage "raft" {
  ...
  trailing_logs          = 10000  # log entries to keep beyond the last snapshot
  snapshot_interval      = "30s"  # compact Raft log every 30s (default 2m)
  snapshot_threshold     = 8192   # also snapshot after this many uncommitted entries
