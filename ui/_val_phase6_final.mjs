...
await page.screenshot({ path: '/Users/raymon.epping/Documents/VSC/HashiCorp/editors_factory/docs/validation/evidence/01_03/phase6-01-good-complete.png', fullPage: true });
await browser.close();
